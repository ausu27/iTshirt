...
/  requiers certain internal working buffer occupies (FF_MAX_LFN + 1) * 2 U08s and
/  additional (FF_MAX_LFN + 44) / 15 * 32 U08s when exFAT is enabled.
...
/   3: Unicode in UTF-32 (TCHAR = DU16)
/
...
/  At the tiny configuration, size of file object (FIL) is shrinked FF_MAX_SS U08s.
